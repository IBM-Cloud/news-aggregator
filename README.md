...
* Plus a lot of other [open source libraries](https://github.com/IBM-Bluemix/news-aggregator/blob/master/NOTICE)
...
[Install the Eclipse Maven plugin (M2Eclipse)](http://www.eclipse.org/m2e/download/)
